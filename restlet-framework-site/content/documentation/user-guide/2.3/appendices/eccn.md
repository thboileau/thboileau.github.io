...
extension](https://github.com/restlet/restlet-framework-java/tree/{{% param version %}}/modules/org.restlet.ext.crypto/src/org/restlet/ext/crypto/internal/)
...
here](https://github.com/restlet/restlet-framework-java/tree/{{% param version %}}/modules/org.restlet/src/org/restlet/engine/ssl/DefaultSslContextFactory.java?view=markup)).
