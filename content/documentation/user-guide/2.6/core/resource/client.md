...
read the [first client](/documentation/user-guide/{{% param version %}}/introduction/first-steps/first-client "First client") page.
...
{{< highlight java "style=emacs" >}}package annos;
