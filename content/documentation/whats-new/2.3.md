---
title: Restlet Framework - What's new 2.3
cascade:
  params:
    version: '2.3'
weight: 4
...
For more details, you can read the [the full list of changes](https://github.com/restlet/restlet-framework-java/blob/2.3/build/tmpl/text/changes.txt).
