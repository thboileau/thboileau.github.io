---
title: Restlet Framework - What's new 2.1
cascade:
  params:
    version: '2.1'
weight: 6
...
For more details, you can read the [the full list of changes](https://github.com/restlet/restlet-framework-java/blob/2.1/build/tmpl/text/changes.txt).
