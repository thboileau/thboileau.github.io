---
title: Restlet Framework - What's new 2.4
cascade:
  params:
    version: '2.4'
weight: 3
...
For more details, you can read the [the full list of changes](https://github.com/restlet/restlet-framework-java/blob/2.4/build/tmpl/text/changes.txt).
