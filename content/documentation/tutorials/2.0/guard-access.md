...
[Cookie](https://javadocs.restlet.talend.com/{{% param version %}}/jse/api/org/restlet/data/Cookie.html) and
[CookieSetting](https://javadocs.restlet.talend.com/{{% param version %}}/jse/api/org/restlet/data/CookieSetting.html) objects
accessible from a [Request](https://javadocs.restlet.talend.com/{{% param version %}}/jse/api/org/restlet/Request.html) or a
